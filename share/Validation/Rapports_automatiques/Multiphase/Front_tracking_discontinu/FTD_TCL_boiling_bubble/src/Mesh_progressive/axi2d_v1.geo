...
Point(1) = {0+l_resolu, 0, 0, 1.0};
Point(2) = {LX*dr+l_resolu, 0, 0, 1.0};
Point(3) = {LX+l_resolu, 0, 0, 1.0};
Point(4) = {LX+l_resolu, LY, 0, 1.0};
Point(5) = {LX*dr+l_resolu, LY, 0, 1.0};
Point(6) = {0+l_resolu, LY, 0, 1.0};
