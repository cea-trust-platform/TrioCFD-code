...
def build_mesh_colin_1(alpha_d, folder, med_name):
    # rayon maillage
    r = 0.02
    # hauteur maillage
    h = 3.08
    ...
    n = 20
    nz = 80
    taux = 0.95  # taux de croissance de la taille des mailles
...
def build_mesh_colin_2(alpha_d, folder, med_name):
    # rayon maillage
    r = 0.02
    # hauteur maillage
    h = 3.08
...
if __name__ == "__main__":
    build_mesh_colin_1(5.0, ".", "mesh_Colin_1.med")
    build_mesh_colin_2(5.0, ".", "mesh_Colin_2.med")
