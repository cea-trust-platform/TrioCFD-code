...
// Quelques commandes : 
// gmsh bulle3.geo & : Pour afficher la géométrie du résultat.
// gmsh bulle3.geo -2 : Pour mailler la surface latérale.
// gmsh bulle3.geo -3 : Pour mailler le volume de la sphère.
