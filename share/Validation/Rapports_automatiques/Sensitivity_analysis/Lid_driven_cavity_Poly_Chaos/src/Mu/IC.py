...
ref= np.loadtxt('../Ref_sens/ux_H.txt', unpack=True, usecols=[1])
t_ref= np.loadtxt('../Ref_sens/ux_H.txt', unpack=True, usecols=[0])
...
ref= np.loadtxt('../Ref_sens/ux_V.txt', unpack=True, usecols=[1])
t_ref= np.loadtxt('../Ref_sens/ux_V.txt', unpack=True, usecols=[0])
...
#plot standard deviation
ref= np.loadtxt('../Ref_sens/uy_V.txt', unpack=True, usecols=[1])
t_ref= np.loadtxt('../Ref_sens/uy_V.txt', unpack=True, usecols=[0])



fig, ax = plt.subplots()
ax.plot(t_ref, ref, dx, variance_y, dx, variance_y_pcm, 'r8', linewidth=2)
ax.legend([ 'El-Beltagy and Wafa', 'Taylor', 'PCM'])
plt.xlabel("y")
