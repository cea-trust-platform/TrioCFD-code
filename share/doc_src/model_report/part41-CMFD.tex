...
As of now, the local relative velocity is defined in the case of a gas-liquid two-phase flow in a vertical pipe so that the centrifugal acceleration is not taken into account, and the transverse component of the relative velocity is only given by the dispersion term. The formulation of the local relative velocity will shortly be extended to the case of rotational two-phase flows. 
