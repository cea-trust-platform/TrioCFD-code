...
%
\fancypagestyle{part}{%
\lfoot{\textit{Plan de Gestion Logiciel TrioCFD, v1.9.0}}
\cfoot{}
\rfoot{\thepage}
...
\vspace{0.4cm}\\
\hspace{2.8cm}\LARGE{\textbf{Plan de Gestion de Configuration de  TrioCFD v1.9.0}}} \end{center}
\vspace{0.3cm}
