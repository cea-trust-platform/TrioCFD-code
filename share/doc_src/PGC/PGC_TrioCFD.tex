...
%
\fancypagestyle{part}{%
\lfoot{\textit{Plan de Gestion Logiciel TrioCFD, v1.8.4}}
\cfoot{}
\rfoot{\thepage}
...
\vspace{0.4cm}\\
\hspace{2.8cm}\LARGE{\textbf{Plan de Gestion de Configuration de  TrioCFD v1.8.4}}} \end{center}
\vspace{0.3cm}
...
\bibliography{BibTeX_PGC_TrioCFD.bib}
\end{document}
