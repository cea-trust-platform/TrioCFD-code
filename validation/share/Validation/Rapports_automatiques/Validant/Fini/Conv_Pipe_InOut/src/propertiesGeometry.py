...
def properties(nomFic):
	...
	chaines = ["Canal_perio { direction_ecoulement",
        	   "mu Champ_Uniforme",
...
def ecritureFichier(D,mu,lamb,Cp,rho,U,Qw,Z,L):
	#ecriture du fichier
	nomFic = 'propertiesGeometry.dat'
	fichier = open(nomFic, 'w')
	fichier.write('%18.8f %18.8f %18.8f %18.8f %18.8f %18.8f %18.8f %18.2f %18.2f\n' % (D,mu,lamb,Cp,rho,U,Qw,Z,L))
	fichier.close()
...
if __name__ == '__main__':
	...
	D,mu,lamb,Cp,rho,U,Qw,Z,L = properties(nomFic)
	
	#ecriture du fichier
	ecritureFichier(D,mu,lamb,Cp,rho,U,Qw,Z,L)
