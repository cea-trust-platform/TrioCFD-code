...
def readPropertiesData():
	...
	chaines = ["# Longueurs",
        	   "mu Champ_Uniforme",
	           "rho Champ_Uniforme",
		   "IN frontiere_ouverte_pression_imposee Champ_Front_Uniforme",
	           "OUT frontiere_ouverte_pression_imposee Champ_Front_Uniforme"] # Texte a rechercher
	...
	for ligne in fic:
	    for chaine in chaines:
			...
			rho=float(tLigne[3])
		    if chaine=="IN frontiere_ouverte_pression_imposee Champ_Front_Uniforme":
			Pin=float(tLigne[4])
		    	print 'Pin:%f' %Pin 
         	    if chaine=="OUT frontiere_ouverte_pression_imposee Champ_Front_Uniforme":
			Pout=float(tLigne[4])
