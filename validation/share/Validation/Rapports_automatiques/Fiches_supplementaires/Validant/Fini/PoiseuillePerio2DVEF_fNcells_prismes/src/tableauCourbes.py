...
if __name__ == '__main__':
    ...
    #discr = args[0]                        Ne marche plus dans ce cas, car nom dossier contient pas infos sur discretisation
    #scheme = args[1]                       Ne marche plus dans ce cas, car nom dossier contient pas infos sur schema
    #U = args[2]                            Ne marche plus dans ce cas, car nom dossier contient pas infos sur vitesse
