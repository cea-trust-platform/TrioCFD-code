...
// Champ destine � post-traiter le gradient d un champ generique
// La classe porte un operateur statistique "gradient"

//// Syntaxe � respecter pour jdd
//
...
//Son application est restreinte � certains champs discrets (pression VDF et VEF ou temperature en VEF)
