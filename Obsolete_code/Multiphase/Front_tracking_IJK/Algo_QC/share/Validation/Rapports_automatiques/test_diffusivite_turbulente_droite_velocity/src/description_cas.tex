Ce cas test correspond \`a la diffusion d'une temp\'erature de paroi impos\'ee \`a vitesse nulle. Il a pour but le test de l'impl\'ementation d'un diffusivit\'e turbulente dans la formulation 'Velocity'.
