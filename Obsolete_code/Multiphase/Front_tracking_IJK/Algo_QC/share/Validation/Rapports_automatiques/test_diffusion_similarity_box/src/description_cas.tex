...
\end{equation}
Le mod\`ele Similarit\'e d'\'echelle correspond au mod\`ele
\begin{equation}
\tau_{ij} = \overline{U_i U_j} - \overline{U}_i\overline{U}_j
\end{equation}
avec $\overline{\phi}$ un filtre test.
