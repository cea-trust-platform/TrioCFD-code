...
if phase=='liq':
    try:
       ...
       print("maximum dissipation totale (pseudo) : ",max(ET))
       print("maximum dissipation fluctu (pseudo) : ",max(EF))
...
#################################################################################
# TRACE DES FIGURES - ENERGIES CINETIQUES
#################################################################################
