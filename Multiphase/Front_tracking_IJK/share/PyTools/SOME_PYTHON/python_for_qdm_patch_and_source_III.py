...
def beautiful_two_plots_no_insert_gr(insert=True, serie1=source, qui1=0, label1="source", couleur1='k', pastille1='oy', serie2=source, qui2=1, label2="source", couleur2='r', pastille2='og', correction="no"):
    # ~~~~~~~~~ Plot toute la serie ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    
    #> ~~~~~~~~ Pour les grandeurs en vitesse, on apporte manuellement ~
    #> ~~~~~~~~ une correction. ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    if not(correction=="no") :
        index_reprise   = np.argwhere(i==0)
        serie1[index_reprise-1,qui1] = serie1[index_reprise-2,qui1]
        serie1[index_reprise,qui1] = serie1[index_reprise+1,qui1]
        serie2[index_reprise-1,qui2] = serie2[index_reprise-2,qui2]
        serie2[index_reprise,qui2] = serie2[index_reprise+1,qui2]
    ...
    ax2.set_xlabel("temps (s)",fontsize=20)
    ax2.legend();
    ...
    #> ~~~~~~~~ une correction. ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    if not(correction=="no"):
        index_reprise_s   = np.argwhere(ist==0)
        print(index_reprise_s[0][0])
        index_reprise_sm   = np.argwhere(ist==0)[0][0]-3
        index_reprise_sp   = np.argwhere(ist==0)[0][0]+3
        print(serie1s[index_reprise_sm:index_reprise_sp,qui1])
        print("BEFORE")
        print(serie1s[index_reprise_s,qui1][0])
        serie1s[index_reprise_s-1,qui1] = serie1s[index_reprise_s-2,qui1]
        serie1s[index_reprise_s  ,qui1] = serie1s[index_reprise_s+1,qui1]
        print("AFTER")
        print(serie1s[index_reprise_s,qui1][0])
        serie2s[index_reprise_s-1,qui2] = serie2s[index_reprise_s-2,qui2]
        serie2s[index_reprise_s  ,qui2] = serie2s[index_reprise_s+1,qui2]
...
if trace_evolutions_temporelles:
    ...
    beautiful_two_plots_no_insert_gr(insert=True, serie1=vit, qui1=0, label1=r"$\overline{u}_x$", couleur1='r', pastille1='og',serie2=vit, qui2=1, label2=r"$\overline{u}_y$", couleur2='g', pastille2='ob',correction="oui")
    beautiful_two_plots_no_insert_gr(insert=True, serie1=dvit, qui1=0, label1=r"$d\overline{u}_x$", couleur1='r', pastille1='og',serie2=dvit, qui2=1, label2=r"$d\overline{u}_y$", couleur2='g', pastille2='ob',correction="oui")
    beautiful_two_plots_no_insert_gr(insert=True, serie1=vit*At, qui1=0, label1=r"$At \times \overline{u}_x$", couleur1='r', pastille1='og',serie2=vit*At, qui2=1, label2=r"$At \times \overline{u}_y$", couleur2='g', pastille2='ob',correction="oui")
