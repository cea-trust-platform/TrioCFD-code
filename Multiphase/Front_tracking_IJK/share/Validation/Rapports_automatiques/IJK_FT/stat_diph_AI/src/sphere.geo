...
Point(2) = {cx+r , cy   ,cz   , h}; // On laisse le sommet en r pour di-symmetrizer
...
// Quelques commandes : 
// gmsh sphere.geo & : Pour afficher la géométrie du résultat.
// gmsh sphere.geo -2 : Pour mailler la surface latérale.
// gmsh sphere.geo -3 : Pour mailler le volume de la sphère.
// gmsh sphere.msh & : Pour afficher le maillage.
